...
const menuData = {
  restaurant: {
    _id: "rest123456789",
    name: "Full_Options",
    logo: "https://example.com/images/full_options_logo.png",
    description:
  ...
  products: [
    // Simple products without options
    {
      ...
      image: "https://example.com/images/green_salad.jpg",
      price: 4.99,
      hasOptions: false,
      hasAddons: false,
      hasVariants: false,
    ...
    // Product with different sizes and non-proportional prices
    {
      ...
      image: "https://example.com/images/chicken_nuggets.jpg",
      price: 0,
      hasOptions: false,
      hasAddons: false,
      hasVariants: true,
    ...
    // Main courses with side dish options
    {
      ...
      image: "https://example.com/images/grilled_steak.jpg",
      price: 24.99,
      hasOptions: true,
      options: [
        {
    ...
    // Drinks with different sizes
    {
      ...
      image: "https://example.com/images/coca_cola.jpg",
      price: 0,
      hasOptions: false,
      hasAddons: false,
      hasVariants: true,
    ...
    // Complete meal (Combo)
    {
      ...
      image: "https://example.com/images/burger_meal.jpg",
      price: 12.99,
      hasOptions: true,
      options: [
        {
    ...
    // Family meal (for sharing)
    {
      ...
      image: "https://example.com/images/family_meal.jpg",
      price: 39.99,
      hasOptions: true,
      options: [
        {
            ...
            <div className="flex items-center gap-4">
              {menuData.restaurant.logo && (
                <img
                  ...
                  className="w-16 h-16 rounded-full border-2 border-[#FFCE18]"
                />
              )}
              <div>
